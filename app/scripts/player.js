/* Player (Being) */
Lemnos.Player = function(xy) {
  Lemnos.Being.call(this,xy);
...
Lemnos.Player.extend(Lemnos.Being);

Lemnos.Player.prototype.doRest = function() {
  // intentionally do nothing to burn a turn, TODO: rest?
}

Lemnos.Player.prototype.definition = {
  "glyph":"@",
  "glyphColor":"#ff0",
  "species":"Player",
...
Lemnos.Player.prototype.handleEvent = function(e) {
  var keyMap = {};
  keyMap[38] = 0;
  keyMap[33] = 1;
  keyMap[39] = 2;
  ...
  if (code == 32) { // spacebar
    ...
    var diffXY = new XY(ROT.DIRS[8][keyMap[code]])
    var newXY = this._xy.plus(diffXY);

    // is it a map space
    var moveResult = this._game.getMoveResult(this,newXY);
...
Lemnos.Player.prototype.drawFov = function() {
  this.scanFov();
...
Lemnos.Player.prototype.resolveBump = function(pobj) {
...
Lemnos.Player.prototype.updateXpProgress = function() {
